...
RegionDict = cfg.region_config._config.__dict__
...
ModelDict = cfg.model_config._config.__dict__
    #
    #
...
ForcingData = cfg.datasets_config.__dict__
    #
    # {'sources': [
    #
...
interp_return = region_model.run_interpolation(region_model.interpolation_parameter, ta, region_env)
